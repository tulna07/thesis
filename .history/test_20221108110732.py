...
def evaluate_reward(Tree = Tree, current_node = Node, next_node = Node , visited_neighbor_nodes=[]):
    ...
    ranking_neighbors_to_current = ranking_list(neighbors_length_to_current)
    ranking_neighbors_to_root = ranking_list(neighbors_length_to_root)
    ...
    reward += (len(ranking_neighbors_to_root) - ranking_neighbors_to_root[next_node_idx])*10        
    reward += ranking_neighbors_to_current[next_node_idx]*10        
