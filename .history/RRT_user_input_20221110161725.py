...
def menu_RRT():
    ...
    parser.add_argument('-sx', metavar="start_x", type=float, help='start point x', default=31.0)
    parser.add_argument('-sy', metavar="start_y", type=float, help='start point y', default=58.0)
