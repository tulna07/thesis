...
def train(start, goal, obstacles=Obstacles(), vision_range=5, Tree=Tree, train_robot = False, view_map=False):
...
if __name__ == '__main__':
    ...
    if not read_tree:
        ...
        train(start=start_cooridinate, goal=goal_coordinate,\
            ...
            Tree=RRT_star, train_robot=train_robot, view_map=view_map)
