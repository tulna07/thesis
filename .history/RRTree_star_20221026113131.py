...
def run_by_reinforcement_learning(goal, vision_range, robot, Tree, obstacles):
    ...
    for episode in range(HM_EPISODES):
        ...
        while True:
           run_by_rrt*(Tree)
            ...
            run_by_reinforcement_learning(goal, vision_range, robot, Tree, obstacles)
