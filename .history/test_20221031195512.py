...
def distance_compare(Tree = Tree, node_1 = Node, node_2 = Node):
    ...
    distance_node_1 = point_dist(root_node.coords, node_1.coords)
    distance_node_2 = point_dist(root_node.coords, node_2.coords)
...
def run_by_reinforcement_learning(goal, vision_range, robot, Tree, obstacles, q_table):
    ...
    if robot.reach_goal:
        ...
        dists = distance_compare(Tree,current_node,next_node)
        print (dists)
