...
def get_nearest_node(input_node_coords, nodes_coords, checked_nodes_coords = []):
    ...
    for node_coords in nodes_coords:
        ...
        if not checked:    
            ...
            continue        
    checked_nodes_coords.append(input_coords)        
    return input_coords, checked_nodes_coords
    
def check_node_obs(Tree = Tree, input_node_coords, obstacles = Obstacles):
    nodes_coords = Tree.all_nodes_coordinate()
    checked_nodes_coords = []
    chech_in_obs = check_inside_obstacles(input_node_coords, obstacles)
    if chech_in_obs:
        nearest_node_coords , checked_nodes_coords = get_nearest_node(input_node_coords, nodes_coords)
        check_node_obs(Tree, nearest_node_coords, obstacles, checked_nodes_coords)
