...
def evaluate_reward(Tree = Tree, current_node = Node, next_node = Node , visited_neighbor_nodes=[], avg_neighbors_to_obs=[]):
    ...
    ranking_neighbors_root = ranking_list(neighbor_to_root)
    middle_value_neighbors_root = middle_value_in_list(ranking_neighbors_root)
    ...
    if (ranking_neighbors_distance_to_obs[next_node_idx] >= middle_value_neighbors_to_obs):
        ...
        reward += middle_value_neighbors_root - ranking_neighbors_root[next_node_idx]*5
        if (ranking_neighbors_root[next_node_idx] < middle_value_neighbors_root):
            ...
            reward -= (len(ranking_neighbors_distance_to_obs) - ranking_neighbors_distance_to_obs[next_node_idx])*5  
