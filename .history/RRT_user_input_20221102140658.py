...
def menu_RRT():
    ...
    parser.add_argument('-sx', metavar="start_x", type=float, help='start point x', default=57.0)
    parser.add_argument('-sy', metavar="start_y", type=float, help='start point y', default=33.0)
