...
def evaluate_reward(Tree = Tree, current_node = Node, next_node = Node , visited_neighbor_nodes=[], avg_neighbors_to_obs=[]):
    ...
    if (neighbors_avg_length[next_node_idx] >= middle_value_neighbors):
        reward -= (neighbors_avg_length[next_node_idx] - middle_value_neighbors)*15     
    else:
        reward += (middle_value_neighbors - neighbors_avg_length[next_node_idx])*15    
    ...
    if (avg_neighbors_to_obs[next_node_idx] >= middle_value_neighbors_to_obs):
        reward -= (avg_neighbors_to_obs[next_node_idx] - middle_value_neighbors_to_obs)*30 
