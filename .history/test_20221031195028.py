...
def distance_compare(Tree = Tree, node_1 = Node, node_2 = Node):
    ...
    distance_node_1 = point_dist(root_node, node_1)
    distance_node_2 = point_dist(root_node, node_2)
...
def run_by_reinforcement_learning(goal, vision_range, robot, Tree, obstacles, q_table):
    ...
    if robot.reach_goal:
        ...
        dists = np.array(Tree.distances(current_node, visited_neighbor_nodes))
