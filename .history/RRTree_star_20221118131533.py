...
def get_node_and_neighbors(Tree,robot,obstacles, vision_range):
    ...
    return robot_state, current_node, neighbor_nodes, visited_neighbor_nodes   

def update_q_table(q_table, temp_q_table,Tree):
...
def run_by_reinforcement_learning(goal, vision_range, robot, Tree, obstacles, q_table,temp_q_table, obs_ls,view_map=False):
    ...
    robot_state, current_node, neighbor_nodes, visited_neighbor_nodes = get_node_and_neighbors(Tree,robot,obstacles,vision_range)
