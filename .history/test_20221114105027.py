...
def get_closer_point_line_segment(node,ls):
...
def evaluate_reward(Tree = Tree, current_node = Node, next_node = Node , visited_neighbor_nodes=[], avg_neighbors_to_obs=[],check_and_ls):
    ...
    current_node_to_closer_ls = get_closer_point_line_segment(current_node, check_and_ls[1])
    next_node_to_closer_ls = get_closer_point_line_segment(next_node, check_and_ls[1])
