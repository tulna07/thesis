...
def menu_RRT():
    ...
    parser.add_argument('-gx', metavar="goal_x", type=float, help='goal point x', default=82.0)
    parser.add_argument('-gy', metavar="goal_y", type=float, help='goal point y', default=43.0)
    
    # running
    
    # parser.add_argument('-sx', metavar="start_x", type=float, help='start point x', default=82.0)
    # parser.add_argument('-sy', metavar="start_y", type=float, help='start point y', default=43.0)
